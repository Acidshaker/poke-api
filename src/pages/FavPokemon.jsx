...
const FavPokemon = () => {
  ...
  const handleClickPrev = () => {
    const prevId = pokemonLike.indexOf(Number(newId)) - 1;
    if (pokemonLike[0] === Number(newId)) {
      setnewId(pokemonLike[pokemonLike.length - 1]);
    } else {
      setnewId(pokemonLike[prevId]);
    }
  };

  const handleClickNext = () => {
    const nextId = pokemonLike.indexOf(Number(newId)) + 1;
    console.log(nextId);
    if (pokemonLike[pokemonLike.length - 1] === Number(newId)) {
      setnewId(pokemonLike[0]);
    } else {
      setnewId(pokemonLike[nextId]);
    }
  };
